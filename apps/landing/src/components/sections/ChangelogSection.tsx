    ...
    <section id="changelog" className="mx-auto max-w-3xl px-8 py-24">
      <div className="mb-12 text-center">
        <Pill
          color="primary"
          indicator="icon"
          icon={<LightIcon name="file-text" size={12} />}
        >
          Release log
        </Pill>
        ...
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          Every release is on npm. The ChangelogList component on this page is
          the same one consumers drop into their own docs sites.
        </p>
      </div>
