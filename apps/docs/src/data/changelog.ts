...
export const facetChangelog: ChangelogRelease[] = [
  ...
  {
    version: "1.1.3, 1.1.4, 1.10.0, 1.4.0, 1.4.5, 1.4.6, 1.9.0",
    date: "2026-08-17",
    tag: "fix",
    title: "v1.1.3, 1.1.4, 1.10.0, 1.4.0, 1.4.5, 1.4.6, 1.9.0",
    changes: [
      {
        kind: "changed",
...
export const CHANGELOG_CHANGE_COUNT = 277;
