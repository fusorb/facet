...
packages/components/   ← 116 styled Radix components (shadcn-style, Radix + tailwind-merge)
...
9. ✅ Tests: vitest workspace, 926 tests across 71 files (10 projects: sdk, store, components, auth, layout, cli, motion, native, docs, emails); 1 pre-existing flake: theme.test.tsx Radix/jsdom
...
3. ✅ **Test infrastructure**: Vitest workspace, 926 tests across 71 files (10 projects: sdk, store, components, auth, layout, cli, motion, native, docs, emails).
